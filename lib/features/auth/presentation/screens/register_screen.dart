...
class _RegisterScreenState extends ConsumerState<RegisterScreen> {
  ...
  void validateDetails(){
    ...
    if(email.isEmpty || password.isEmpty){
      ...
      ref.read(authControllerProvider.notifier).createUserWithEmailAndPassword(email, password);
    }
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text('Join us...', style: AppTheme.purpleCardTitle,),
                  SizedBox(height: 3.h,),
                  ...
                  Text('Already have an account?', style: AppTheme.appSubText,),
